...
function(hct_autoload directory)
    ...
    foreach (makefile ${makefiles})
        ...
        string(FIND "${makefile_contents}" "$(RELATIVE)Makefile." is_relative_makefile2)
        string(FIND "${makefile_contents}" "#HCTMarker" is_hct_marked)
        if (${is_hwlib_makefile} EQUAL -1 AND ${is_hct_marked} EQUAL -1 AND ${is_relative_makefile} EQUAL -1 AND ${is_relative_makefile2} EQUAL -1)
            continue()
        endif ()
